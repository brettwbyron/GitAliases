...
###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!
# WARNING: ALL CONTENT FROM HERE TO EOF WILL UPDATE WITH "update" COMMAND
###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!###!!!
...
echo $SFTP_PSWD | pbcopy && sftp -r $SFTP_USER@sftp.jobvite.com:/uploads/$branch << EOF
get -r dev
EOF
...
alias fzu="echo $SFTP_PSWD | pbcopy | sftp $SFTP_USER@sftp.jobvite.com:/uploads/"
alias fzr="echo $SFTP_PSWD | pbcopy | sftp $SFTP_USER@sftp.jobvite.com:/uploads/$(getCurrentWorktreeName)"
